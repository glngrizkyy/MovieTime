...
import 'package:movietime/bloc/get_tv_up_the_air_bloc.dart';
...
// import 'package:movietime/widgets/tvscreen.dart';
import 'package:page_indicator/page_indicator.dart';

class TVOnAir extends StatefulWidget {
  TVOnAir({Key key}) : super(key: key);

  @override
  _TVOnAirState createState() => _TVOnAirState();
}

class _TVOnAirState extends State<TVOnAir> {
  ...
  void initState() {
    super.initState();
    nowPlayingTVBloc..getTVonAir();
  }

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<TVResponse>(
      stream: nowPlayingTVBloc.subject.stream,
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      ...
                      //   context,
                      //   MaterialPageRoute(
                      //     builder: (context) => TVScreen(tv: tv[index]),
                      //   ),
                      // );
                    },
                    child: Stack(
