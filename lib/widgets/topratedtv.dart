...
import 'package:movietime/bloc/get_top_rated_tv_bloc.dart';
...
class BestTVShow extends StatefulWidget {
  BestTVShow({Key key}) : super(key: key);

  @override
  _BestTVShowState createState() => _BestTVShowState();
}

class _BestTVShowState extends State<BestTVShow> {
  @override
  void initState() {
    super.initState();
    tvsBloc..getTVs();
